...
public class OrderEquivalentMaximalSegment extends LineSegment {
     ...
     * @param set1         the blocks that should be to the left/bottom of the
     *                     maximal
     *                     segment
     * @param set2         the blocks that should be to the right/top of the
     *                     maximal
     *                     segment
     * @param allLabels    a list containing all the labels occuring in the
     *                     treemap
     */
