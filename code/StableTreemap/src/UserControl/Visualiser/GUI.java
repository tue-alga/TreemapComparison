...
public final class GUI extends javax.swing.JFrame {
    ...
    public GUI(Visualiser visualiser) {
        ...
        String[] generators = new String[]{"SliceAndDice", "NumberBalancedPartition", "SizeBalancedPartition", "SequenceBalancedPartition", "PivotByMiddle", "PivotBySize", "PivotBySplitSize", "Strip", "StripLookAhead", "Split", "Squarified", "SquarifiedLookAhead", "Spiral", "SpiralLookAhead", "Moore", "Hilbert", "Approximation", "Incremental", "NoMovesIncremental"};
    ...
    public void setDataFacilitator(String identifier) {
        ...
        switch (identifier) {
            case "Random":
                ...
                break;
            case "m-names":
                df = new DataFileManagerFast(new File("").getAbsolutePath() + sep + ".." + sep + "Data" + sep + "Datasets" + sep + "DutchNames", false);
                break;
            case "m-coffee":
    ...
    public void setTreeMapGenerator(String identifier) {
        ...
        switch (identifier) {
            ...
            case "NoMovesIncremental":
                ...
                break;
            case "NumberBalancedPartition":
                tmg = new NumberBalancedPartition();
                break;
            case "SequenceBalancedPartition":
                tmg = new SequenceBalancedPartition();
                break;
            case "SizeBalancedPartition":
